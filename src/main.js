...
const actors = [
  { id:'sofia', name:'Sofía Reyes', tag:'Miami Latina · Warm', accent:'Neutral US Latina', tone:'Warm, confident, consultative', langs:'English + Spanish', gender:'Female', voice:'ElevenLabs · Domi · multilingual v2', voiceId:'AZnzlk1XvdvUeBnXmlld', best:'Property managers, condo boards, hospitality', calls:1284, connect:'38.4%', book:'12.1%', color:'#a473ff' },
  { id:'diego', name:'Diego Alvarez', tag:'Miami Latino · Direct', accent:'Neutral US Latino', tone:'Direct, energetic, executive', langs:'English + Spanish', gender:'Male', voice:'ElevenLabs · Adam · multilingual v2', voiceId:'pNInz6obpgDQGcFmaJgB', best:'Facility directors, chief engineers, industrial', calls:963, connect:'34.7%', book:'10.4%', color:'#4b93ff' },
