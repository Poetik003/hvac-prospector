        ...
        // IMMEDIATE SYNTAX CHECK - Test if JavaScript loads properly
        try {
            console.log('✅ JavaScript syntax is valid - continuing initialization');
            
            // SIMPLE BUTTON TEST - Add immediate test for button responsiveness  
            setTimeout(function() {
                console.log('🧪 Creating test button...');
                const testButton = document.createElement('button');
                testButton.innerHTML = '🧪 CLICK TO TEST';
                ...
                testButton.onclick = function() {
                    alert('✅ BUTTONS WORK! All JavaScript is functional.');
                    testButton.remove();
                };
            ...
            console.error('❌ JavaScript syntax error detected:', error);
        }
        ...
        function showScriptReadingPlayer(audioUrl, voiceModel, scriptText, isCustomGenerated = false) {
            ...
            audioContainer.innerHTML = `
                ...
                <div style="text-align: center; margin-bottom: 15px;">
                    ...
                    <button onclick="readScriptDirectly()" 
            ...
            modalContainer.innerHTML = `
                <div style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); border-radius: 20px; padding: 30px; color: white; max-width: 600px; width: 100%; max-height: 90vh; overflow-y: auto; border: 2px solid rgba(59, 130, 246, 0.6); box-shadow: 0 20px 60px rgba(0,0,0,0.8);">
                    ...
                    <div style="display: grid; gap: 15px; margin-bottom: 25px;">
                        ...
                        <button onclick="readScriptWithVoice()" 
